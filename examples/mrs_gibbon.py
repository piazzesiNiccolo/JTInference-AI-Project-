...
def mrs_gibbon_example():
    ...
    print(jt.query('h'))
    print('\np(holmes) con evidenza  watson = yes e sprinkler = yes')
    w_evidence = (watson,1)
    ...
    print(jt.query('w'))
    print('p(watson) con evidenza gibbon = yes e holmes = no')
    g_evidence = (gibbon, 1)
    h_evidence = (holmes,0)
    ...
    #r query
    jt.init_tree()
    print('p(rain) senza evidenza')
    print(jt.query('r'))
    print('p(rain) con evidenza  watson = yes e holmes = yes')
    h_evidence = (holmes, 1)
    ...
    #s query
    jt.init_tree()
    print('p(sprinkler) senza evidenza')
    print(jt.query('s'))
    print('p(sprinkler) con evidenza  holmes = yes')
    ...
    print(jt.query('g'))
    print('p(g) con evidenza  watson = yes')
    w_evidence = (watson, 1)
